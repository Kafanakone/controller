    ...
    <div class="row" id="lessonList">
      <div class="col-12 col-lg-4">
            <div class="card shadow">
                <img src="img/css.jpeg" alt="Animations CSS modernes" class="card-img-top">
                <div class="card-body">
                 ...
                 <a href="lesson1.php" class="btn btn-primary stretched-link">Démarrer l'apprentissage</a>
            </div>
      </div>
      <div class="col-12 col-lg-4">
        <div class="card shadow">
          <img src="img/js.jpeg" alt="Programmation JavaScript" class="card-img-top">
          <div class="card-body">
          ...
          <a href=" " class="btn btn-primary stretched-link">Démarrer l'apprentissage</a>
        </div>
      </div>
      <div class="col-12 col-lg-4">
        <div class="card shadow">
          <img src="img/swift.jpeg" alt="Programmation Swift" class="card-img-top">
          <div class="card-body">
